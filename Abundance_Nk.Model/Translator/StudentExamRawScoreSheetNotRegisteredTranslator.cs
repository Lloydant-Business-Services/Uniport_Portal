...
{
    public class StudentExamRawScoreSheetNotRegisteredTranslator :
        TranslatorBase<StudentExamRawScoreSheet, STUDENT_EXAM_RAW_SCORE_SHEET_RESULT_NOT_REGISTERED>
    {
        private readonly CourseTranslator courseTranslator;
        private readonly LevelTranslator levelTranslator;
        private readonly SemesterTranslator semesterTranslaror;
        ...
        public override StudentExamRawScoreSheet TranslateToModel(
            STUDENT_EXAM_RAW_SCORE_SHEET_RESULT_NOT_REGISTERED entity)
        {
            try
            {
        ...
        public override STUDENT_EXAM_RAW_SCORE_SHEET_RESULT_NOT_REGISTERED TranslateToEntity(
            StudentExamRawScoreSheet model)
        {
            try
            {
