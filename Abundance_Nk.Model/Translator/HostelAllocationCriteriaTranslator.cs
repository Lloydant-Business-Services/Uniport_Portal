...
{
    public class HostelAllocationCriteriaTranslator : TranslatorBase<HostelAllocationCriteria, HOSTEL_CRITERIA>
    {
        ...
        public override HostelAllocationCriteria TranslateToModel(HOSTEL_CRITERIA entity)
        {
        ...
        public override HOSTEL_CRITERIA TranslateToEntity(HostelAllocationCriteria model)
        {
            HOSTEL_CRITERIA entity = null;

            if (model != null)
            {
                entity = new HOSTEL_CRITERIA();
                entity.Id = model.Id;
