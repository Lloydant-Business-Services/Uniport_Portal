...
{
    public class AdmissionCriteriaForOLevelSubjectAlternativeTranslator :
        TranslatorBase<AdmissionCriteriaForOLevelSubjectAlternative, ADMISSION_CRITERIA_FOR_O_LEVEL_SUBJECT_ALTERNATIVE>
    {
        private readonly AdmissionCriteriaForOLevelSubjectTranslator admissionCriteriaForOLevelSubjectTranslator;
        ...
        public override AdmissionCriteriaForOLevelSubjectAlternative TranslateToModel(
            ADMISSION_CRITERIA_FOR_O_LEVEL_SUBJECT_ALTERNATIVE entity)
        {
            try
            {
                ...
                if (entity != null)
                {
                    ...
                    model.Alternative =
                        admissionCriteriaForOLevelSubjectTranslator.Translate(
                            entity.ADMISSION_CRITERIA_FOR_O_LEVEL_SUBJECT);
        ...
        public override ADMISSION_CRITERIA_FOR_O_LEVEL_SUBJECT_ALTERNATIVE TranslateToEntity(
            AdmissionCriteriaForOLevelSubjectAlternative model)
        {
            try
            {
