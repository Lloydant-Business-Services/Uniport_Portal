...
{
    public class AdmissionCriteriaForOLevelSubjectTranslator :
        TranslatorBase<AdmissionCriteriaForOLevelSubject, ADMISSION_CRITERIA_FOR_O_LEVEL_SUBJECT>
    {
        private readonly AdmissionCriteriaTranslator admissionCriteriaTranslator;
        private readonly OLevelGradeTranslator oLevelGradeTranslator;
