...
namespace Abundance_Nk.Model.Translator
{
    public class PersonTranslator : TranslatorBase<Person, PERSON>
    {
        ...
        private readonly NationalityTranslator nationalityTranslator = new NationalityTranslator();
        private readonly PersonTypeTranslator personTypeTranslator;
        private readonly ReligionTranslator religionTranslator;
        ...
        public override Person TranslateToModel(PERSON personEntity)
        {
            try
            {
                ...
                if (personEntity != null)
                {
                    ...
                    person.IDCardNumber = personEntity.ID_Card_Number;
                    person.InstitutionalEmail = personEntity.Institutional_Email;
        ...
        public override PERSON TranslateToEntity(Person person)
        {
            try
            {
                ...
                if (person != null)
                {
                    ...
                    if (person.InstitutionalEmail != null)
                    {
                        personEntity.Institutional_Email = person.InstitutionalEmail;
                    }
                    if (person.IDCardNumber != null)
                    {
                        personEntity.ID_Card_Number = person.IDCardNumber;
                    }
