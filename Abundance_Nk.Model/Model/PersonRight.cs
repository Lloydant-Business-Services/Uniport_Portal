            ...
            if (Rights != null)
            {
                if (Rights.Count > 0)
                {
                    foreach (Right right in Rights)
                    {
                        ...
                        //can manage student
                        if (CanViewStudentList == false && CanViewStudentWithoutPassport == false &&
                            CanModifyStudentPassport == false && CanViewAndPrintAdmissionLetter == false)
                        {
                        ...
                        //can manage subject
                        if (CanSetupSubject == false && CanSetupSubjectCategory == false &&
                            CanSetupLevelSubject == false)
                        {
                        ...
                        if (CanUploadResult == false && CanUploadComment == false && CanUploadAttendance == false &&
                            CanUploadPsychomotor == false)
                        {
                        ...
                        if (CanEditUploadedResult == false && CanEditUploadedComment == false &&
                            CanEditUploadedAttendance == false && CanEditUploadedPsychomotor == false)
                        {
                        ...
                        //can check result
                        if (CanViewAndPrintStudentResultMasterSheet == false &&
                            CanViewAndPrintStudentReportCard == false)
                        {
                        ...
                        //can manage users
                        if (CanSetupUsers == false && CanSetupRights == false && CanSetupRoles == false &&
                            CanSetupAssignRightToRole == false && CanSetupAssignRoleToUser == false &&
