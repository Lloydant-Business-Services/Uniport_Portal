...
namespace Abundance_Nk.Data
{
    public class Repository : IRepository, IDisposable
    {
        ...
        //public async Task<E> GetByAsync<E>(object id) where E : class
        //{
        //    try
        //    {
        ...
        public ICollection<E> GetBy<E>(Expression<Func<E, bool>> filter = null,
        ...
        public void Delete<E>(Expression<Func<E, bool>> predicate) where E : class
        {
            ...
            {
                DbSet<E> dbSet = context.Set<E>();
                IEnumerable<E> records = from x in dbSet.Where(predicate) select x;
        ...
        public async Task<List<E>> GetAllAsync<E>() where E : class
        {
            try
            {
        ...
        public async Task<E> GetByAsync<E>(int id) where E : class
        {
            try
            {
                return await context.Set<E>().FindAsync(id);
        ...
        public async Task<List<E>> FindAllAsync<E>(Expression<Func<E, bool>> match) where E : class
        {
            try
            {
        ...
        public async Task<E> GetByFODAsync<E>(Expression<Func<E, bool>> filter = null,
            Func<IQueryable<E>, IOrderedQueryable<E>> orderBy = null, string includeProperties = "") where E : class
        {
            try
            {
