...
{
    public class StudentEmploymentInformationLogic :
        BusinessBaseLogic<StudentEmploymentInformation, STUDENT_EMPLOYMENT_INFORMATION>
    {
        ...
        public bool Modify(StudentEmploymentInformation studentEmploymentInformation)
        {
            try
            {
                STUDENT_EMPLOYMENT_INFORMATION entity =
                    GetEntityBy(s => s.Student_Employment_Information_Id == studentEmploymentInformation.Id);
