...
namespace Abundance_Nk.Business
{
    public abstract class BusinessBaseLogic<T, E> : IDisposable where E : class
    {
        ...
        public async virtual Task<E> GetEntityByAsync(Expression<Func<E, bool>> selector)
        {
            try
            {
                return await repository.GetSingleByAsync(selector);
            }
            catch (Exception ex)
            {
                if (ex.GetType() == typeof(InvalidOperationException))
        ...
        public async virtual Task<T> CreateAsync (T model)
        {
            try
            {
                E entity = translator.Translate(model);
                E addedEntity = await repository.AddAsync(entity);
        ...
        public async virtual Task<List<T>> GetModelsByAsync(Expression<Func<E, bool>> selector = null,
           Func<IQueryable<E>, IOrderedQueryable<E>> orderBy = null, string includeProperties = "")
        {
            try
            {
                List<E> entity = await repository.GetByAsync(selector, orderBy, includeProperties);
                return translator.Translate(entity);
            }
            catch (Exception ex)
            {
        ...
        public async virtual Task<T> GetModelsByFODAsync(Expression<Func<E, bool>> selector = null,
            Func<IQueryable<E>, IOrderedQueryable<E>> orderBy = null, string includeProperties = "")
        {
            try
            {
                E entity = await repository.GetByFODAsync(selector, orderBy, includeProperties);
                return translator.Translate(entity);
            }
            catch (Exception ex)
            {
        ...
        public async virtual Task<T> GetModelByAsync(Expression<Func<E, bool>> selector = null)
        {
            try
            {
                E entity = await repository.GetSingleByAsync(selector);
                return translator.Translate(entity);
            }
            catch (Exception ex)
            {
        ...
        public async virtual Task<List<E>> GetEntitiesByAsync(Expression<Func<E, bool>> selector = null,
            Func<IQueryable<E>, IOrderedQueryable<E>> orderBy = null, string includeProperties = "")
        {
            try
            {
                return await repository.GetByAsync(selector, orderBy, includeProperties);
            }
            catch (Exception ex)
            {
                if (ex.GetType() == typeof(InvalidOperationException))
        ...
        public async virtual Task<List<T>> GetAllAsync()
        {
            try
            {
                List<E> entities = await repository.GetAllAsync<E>();
                return translator.Translate(entities);
            }
            catch (Exception ex)
            {
