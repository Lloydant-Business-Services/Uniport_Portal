...
{
    public class StudentFinanceInformationLogic :
        BusinessBaseLogic<StudentFinanceInformation, STUDENT_FINANCE_INFORMATION>
    {
        ...
        public bool Modify(StudentFinanceInformation studentFinanceInformation)
        {
            try
            {
                Expression<Func<STUDENT_FINANCE_INFORMATION, bool>> selector =
                    p => p.Person_Id == studentFinanceInformation.Student.Id;
