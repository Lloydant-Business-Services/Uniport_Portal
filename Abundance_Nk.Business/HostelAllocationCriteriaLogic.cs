...
{
    public class HostelAllocationCriteriaLogic : BusinessBaseLogic<HostelAllocationCriteria, HOSTEL_CRITERIA>
    {
       ...
       public bool Modify(HostelAllocationCriteria hostelAllocationCriteria)
       {
           try
           {
               HOSTEL_CRITERIA entity = GetEntityBy(x => x.Id == hostelAllocationCriteria.Id);
               if (entity != null)
               {
