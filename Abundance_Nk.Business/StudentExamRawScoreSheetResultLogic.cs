...
{
    public class StudentExamRawScoreSheetResultLogic :
        BusinessBaseLogic<StudentExamRawScoreSheet, STUDENT_EXAM_RAW_SCORE_SHEET_RESULT>
    {
        ...
        public List<ExamRawScoreSheetReport> GetScoreSheetBy(Session session, Semester semester, Course course,
        ...
        public bool Modify(StudentExamRawScoreSheet studentExamRawScoreSheet)
        {
            try
            {
                ...
                {
                    Expression<Func<STUDENT_EXAM_RAW_SCORE_SHEET_RESULT, bool>> selector =
