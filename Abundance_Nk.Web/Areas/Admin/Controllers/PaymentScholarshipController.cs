...
namespace Abundance_Nk.Web.Areas.Admin.Controllers
{
    ...
    {
        private readonly Abundance_NkEntities db = new Abundance_NkEntities();

        // GET: Admin/PaymentScholarship
        public ActionResult Index()
        {
            IQueryable<PAYMENT_SCHOLARSHIP> pAYMENT_SCHOLARSHIP =
                db.PAYMENT_SCHOLARSHIP.Include(p => p.PERSON).Include(p => p.SESSION);
        ...
        public ActionResult Create(
            [Bind(Include = "Id,Person_Id,Session_id,Amount,Scholarship_Name")] PAYMENT_SCHOLARSHIP pAYMENT_SCHOLARSHIP)
        {
