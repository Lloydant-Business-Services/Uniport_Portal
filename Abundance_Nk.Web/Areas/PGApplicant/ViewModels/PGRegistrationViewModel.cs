...
{
    public class PGRegistrationViewModel
    {
        ...
        public PGRegistrationViewModel()
        {
        ...
        public void InitialiseOLevelResult()
        {
            try
            {
                ...
                {
                    Grade = new OLevelGrade { Id = 0 },
                    Subject = new OLevelSubject { Id = 0 }
                };
        ...
        private void PopulateAllApplicantDropDowns()
        {
            ...
            try
            {
                ...
                Relationships = relationshipLogic.GetAll();
                Programmes = programmeLogic.GetModelsBy(g=>g.Programme_Name.Contains("PG"));
            ...
            try
            {
                if (personId > 0)
                {
                    ...
                    StudentAcademicInformation studentAcademicInformation =
                        academicInformationLogic.GetModelBy(p => p.Person_Id == personId);
                    StudentFinanceInformation studentFinanceInformation =
                        financeInformationLogic.GetModelBy(p => p.Person_Id == personId);
                    StudentEmploymentInformation studentEmploymentInformation =
                        employmentInformationLogic.GetModelBy(p => p.Person_Id == personId);
                    ...
                    OLevelResult studentFirstSittingOLevelResult =
                        oLevelResultLogic.GetModelsBy(p => p.Person_Id == personId && p.O_Level_Exam_Sitting_Id == 1)
                            .FirstOrDefault();
                    OLevelResult studentSecondSittingOLevelResult =
                        oLevelResultLogic.GetModelsBy(p => p.Person_Id == personId && p.O_Level_Exam_Sitting_Id == 2)
                            .FirstOrDefault();
                    PreviousEducation previousEducation =
                        previousEducationLogic.GetModelsBy(p => p.Person_Id == personId).FirstOrDefault();

                    StudentLevel studentLevel = studentLevelLogic.GetBy(personId);

                    if (studentSponsor != null && studentAcademicInformation != null &&
                        studentFinanceInformation != null &&
                        (studentFirstSittingOLevelResult != null || studentSecondSittingOLevelResult != null))
                    {
                    ...
                    {
                        StudentFirstSittingOLevelResultDetails =
                            oLevelResultDetailLogic.GetModelsBy(
                                p => p.Applicant_O_Level_Result_Id == studentFirstSittingOLevelResult.Id);
                    }

                    if (studentSecondSittingOLevelResult != null && studentSecondSittingOLevelResult.Id > 0)
                    {
                        StudentSecondSittingOLevelResultDetails =
                            oLevelResultDetailLogic.GetModelsBy(
                                p => p.Applicant_O_Level_Result_Id == studentSecondSittingOLevelResult.Id);
                    }
                    ...
                    SetStudentFirstSittingOLevelResult(studentFirstSittingOLevelResult,
                        StudentFirstSittingOLevelResultDetails);
                    SetStudentSecondSittingOLevelResult(studentSecondSittingOLevelResult,
                        StudentSecondSittingOLevelResultDetails);
        ...
        public void SetStudentFirstSittingOLevelResult(OLevelResult oLevelResult,
        ...
        public void SetStudentSecondSittingOLevelResult(OLevelResult oLevelResult,
            List<OLevelResultDetail> oLevelResultDetails)
        {
            try
            {
