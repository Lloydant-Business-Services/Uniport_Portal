...
namespace Abundance_Nk.Web.Models
{
    public class StudentFormViewModelBase
    {
        ...
        public StudentFormViewModelBase()
        {
            ...
            StudentEmploymentInformation.Student = new Student();
                ...
                if(ApplicationForm != null && ApplicationForm.Id > 0)
                {
                    ...
                    ApplicantFirstSittingOLevelResult =
                        oLevelResultLogic.GetModelBy(
                            p =>
                                p.Person_Id == person.Id && p.O_Level_Exam_Sitting_Id == 1 &&
                                p.Application_Form_Id != null);
                    ApplicantSecondSittingOLevelResult =
                        oLevelResultLogic.GetModelBy(
                            p =>
                                p.Person_Id == person.Id && p.O_Level_Exam_Sitting_Id == 2 &&
                                p.Application_Form_Id != null);
        ...
        public void LoadStudentInformationFormBy(long personId)
        {
            try
            {
                if(personId > 0)
                {
                    ...
                    NextOfKin = nextOfKinLogic.GetModelsBy(p => p.Person_Id == personId).FirstOrDefault();
        ...
        public Student GetStudentBy(long personId)
        {
            try
            {
        ...
        public void SetStudentNextofKin(NextOfKin nextOfKin)
        {
            try
            {
                if(nextOfKin != null)
                {
                    Sponsor.Name = nextOfKin.Name;
                    Sponsor.ContactAddress = nextOfKin.ContactAddress;
                    Sponsor.MobilePhone = nextOfKin.MobilePhone;

                    if(nextOfKin.Relationship != null)
                    {
                        Sponsor.Relationship = nextOfKin.Relationship;
                    }
                    else
                    {
                        Sponsor.Relationship = new Relationship();
        ...
        public void SetStudentNdResult(StudentNdResult ndResult)
        {
            try
            {
                if(ndResult != null)
                {
                    ...
                    {
                        StudentNdResult.Student = new Student();
                    }
