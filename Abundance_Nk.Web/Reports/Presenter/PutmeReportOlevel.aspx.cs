...
{
    public partial class PutmeReportOlevel : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Department department,InstitutionChoice institutionChoice)
        {
            try
            {
                ...
                List<PutmeSlip> report = putmeResultLogic.GetPUTMEReportOlevelByChoice(department, 17, institutionChoice);
