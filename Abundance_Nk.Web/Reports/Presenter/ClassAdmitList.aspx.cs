...
{
    public partial class ClassAdmitList : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Session session, Programme programme, Department department, Level level)
        {
            try
            {
                ...
                List<Model.Model.ClassAdmitCard> Cards = paymentLogic.GetClassAdmitCardWithoutCourses(department, programme, level, session);

                string bind_dsCards = "dsClassAdmit";
        ...
        private async Task DownloadBulk()
        {
            try
            {
                ...
                {
                    var paymentLogic = new PaymentLogic();
                    List<Model.Model.ClassAdmitCard> Cards =await paymentLogic.GetClassAdmitCardWithoutCoursesAsync(department, SelectedProgramme, SelectedLevel, SelectedSession);
