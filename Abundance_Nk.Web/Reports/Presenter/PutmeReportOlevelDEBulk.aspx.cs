...
{
    public partial class PutmeReportOlevelDEBulk : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Department department,InstitutionChoice institutionChoice)
        {
            try
            {
                ...
                List<PutmeSlip> report = putmeResultLogic.GetPUTMEReportOlevelByChoice(department, 18, new InstitutionChoice() { Id = institutionChoice.Id });
