...
{
    public partial class ApplicationFormSummary :Page
    {
        ...
        private void DisplayReportBy(Session session)
        {
            try
            {
                ...
                List<Model.Model.ApplicationFormSummary> applicationFormSummary =
                    applicationFormLogic.GetSummary(session);
                ...
                if(applicationFormSummary != null)
                {
                    ...
                    rv.LocalReport.DataSources.Add(new ReportDataSource(bind_dsApplicationFormSummary.Trim(),
