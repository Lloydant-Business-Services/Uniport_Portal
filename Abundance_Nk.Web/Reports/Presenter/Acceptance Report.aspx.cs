...
{
    public partial class Acceptance_Report :Page
    {
        ...
        private void DisplayReportBy(Department department,Programme programme)
        {
            try
            {
                var s = new Session { Id = 1 };
                var paymentLogic = new PaymentLogic();
                List<AcceptanceView> report = paymentLogic.GetAcceptanceReportBy(s,department,programme);
