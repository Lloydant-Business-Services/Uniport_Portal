...
{
    public partial class CarryOverReport :Page
    {
        ...
        protected void Page_Load(object sender,EventArgs e)
        {
            ...
            {
                lblMessage.Text = "";
                if(Request.QueryString["deptId"] != null && Request.QueryString["progId"] != null &&
                    Request.QueryString["sessionId"] != null && Request.QueryString["semesterId"] != null &&
                    Request.QueryString["levelId"] != null)
                {
        ...
        private void BuildCarryOverCourseList(int deptId,int progId,int levelId,int sessionId,int semesterId)
        {
            try
            {
                var department = new Department { Id = deptId };
                var programme = new Programme { Id = progId };
                ...
                List<CarryOverReportModel> carryOverList = courseRegistrationLogic.GetCarryOverList(department,
                    programme,session,level,semester);
                ...
                if(carryOverList != null)
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource(bind_dsCarryOverStudentList.Trim(),
                        carryOverList));
