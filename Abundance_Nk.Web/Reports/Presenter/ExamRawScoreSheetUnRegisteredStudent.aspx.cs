...
{
    public partial class ExamRawScoreSheetUnRegisteredStudent :Page
    {
            ...
            Level level,Programme programme)
        {
            try
            {
                var studentExamRawScoreSheetResultLogic = new StudentExamRawScoreSheetNotRegisteredLogic();
                List<ExamRawScoreSheetReport> examRawScoreSheetReportList =
                    studentExamRawScoreSheetResultLogic.GetScoreSheety(session,semester,course,department,level,
                        programme);
            ...
            try
            {
                ...
                courses =
                    courseLogic.GetModelsBy(
                        p =>
                            p.Department_Id == SelectedDepartment.Id && p.Level_Id == SelectedLevel.Id &&
