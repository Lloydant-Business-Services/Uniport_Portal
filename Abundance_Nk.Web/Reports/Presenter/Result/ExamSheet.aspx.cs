...
{
    public partial class ExamSheet :Page,IReport
    {
            ...
            int option)
        {
            try
            {
                ...
                if(sessionSemester != null)
                {
                    ...
                    results = courseRegistrationLogic.GetExamSheetBy(level,programme,department,
                ...
                string programmeName = programme.Id > 2 ? "Programme" : "Programme ";
