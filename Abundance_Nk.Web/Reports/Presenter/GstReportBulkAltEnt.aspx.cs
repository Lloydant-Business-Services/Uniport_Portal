...
{
    public partial class GstReportBulkAltEnt : System.Web.UI.Page
    {
        ...
        public void BulkOperations()
        {
            try
            {
                ...
                string directoryName = "ent_" + DateTime.Now.ToString().Replace("/", "").Replace(":", "").Replace(" ", "");
                ...
                foreach (Department deptDepartment in departments)
                {
                    foreach (Course coCourse in courseList)
                    {
                        ...
                        if (report.Count > 0)
                        {
                            ...
                            string reportPath = @"Reports\Result\ExamRawScoreSheetENT.rdlc";

                            var rptViewer = new ReportViewer();
                            rptViewer.Visible = false;
                            rptViewer.Reset();
                            rptViewer.LocalReport.DisplayName = "ENT Result";
