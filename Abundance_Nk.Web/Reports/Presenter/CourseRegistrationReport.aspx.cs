...
{
    public partial class CourseRegistrationReport :Page
    {
        ...
        private void DisplayReportBy(Session session,Programme programme,Department department,Level level)
        {
            try
            {
                ...
                List<CourseRegistrationReportModel> report =
                    courseRegistrationDetailLogic.GetCourseRegistrationBy(session,programme,department,level);
                ...
                if(report != null)
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource(bind_dsCourseRegistration.Trim(),
                        report));
