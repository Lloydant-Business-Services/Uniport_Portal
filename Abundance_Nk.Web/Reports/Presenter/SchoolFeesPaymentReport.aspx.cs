...
{
    public partial class SchoolFeesPaymentReport :Page
    {
        ...
        private void DisplayReportBy(Session session)
        {
            try
            {
                ...
                List<Model.Model.PaymentReport> report = paymentLogic.GetPaymentsBy(session);
                ...
                if(report != null)
                {
                    ...
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource(bind_dsSchoolFeesPayment.Trim(),
                        report));
