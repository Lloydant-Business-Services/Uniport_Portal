...
{
    public partial class SchoolFeesReport : System.Web.UI.Page
    {
        ...
        private void DisplayReportBy(Session session, Level level,Programme programme, Department department, string sortOption)
        {
            try
            {
                ...
                List<PaymentView> payments = paymentModeLogic.GetPaymentReport(session, level, programme, department, paymentMode,txtBoxDateFrom.Text,txtBoxDateTo.Text);
                ...
                reportPath = @"Reports\SchoolFeesReport.rdlc";
        ...
        //        List<PaymentView> payments = paymentModeLogic.GetDebtorsListFull(SelectedSession, SelectedLevel, paymentMode, txtBoxDateFrom.Text, txtBoxDateTo.Text);
        ...
        //        {
        //            reportPath = @"Reports\DebtorsReportAll.rdlc";
        //        }
